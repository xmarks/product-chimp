<?php
/**
 * Product Chimp debug functions
 *
 * Debug Helper functions are included here
 *  - Any temporary tests should be run on this file as well.
 *  - This file loads only in Debug Mode `wp-config.php WP_DEBUG = TRUE`
 *  - This file is ignored from `lint:wpcs`
 *
 ...
 */
if ( file_exists( get_template_directory() . '/inc/debug.php' ) ) {
