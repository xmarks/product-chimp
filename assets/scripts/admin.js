 ...
 *
 * @see wp_localize_script() - The product_chimp_dismiss_plugin_notice object containing:
 ...
 *
 * @var {object} product_chimp_plugin_notice The localized object containing the AJAX URL and nonce.
 * @var {string} product_chimp_plugin_notice.ajax_url The URL for making AJAX requests.
 * @var {string} product_chimp_plugin_notice.nonce The nonce for security verification of the AJAX request.
 *
 * @package Product_Chimp
 */
...
jQuery( document ).ready( function ( $ ) {
    ...
    $( '.st-dismiss-plugin-notice' ).on( 'click', function ( e ) {
        ...
        $.post( product_chimp_plugin_notice.ajax_url, {
            action: 'product_chimp_dismiss_plugin_notice', // The action triggered in the server-side callback.
            nonce: product_chimp_plugin_notice.nonce // Security nonce for the request.
        } );
